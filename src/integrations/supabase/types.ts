  ...
  public: {
    ...
    Functions: {
      ...
      vendedor_cola_calc: {
        ...
        Returns: {
          email: string
          escalado_ia_at: string
          escalado_ia_motivo: string
          etapa_venta: string
          facebook: string

...
const VoiceCallLive = lazy(() => import("@/components/landing/VoiceCallLive").then(m => ({ default: m.VoiceCallLive })));
...
// ── Agente de voz: extraído a src/components/landing/VoiceCallLive.tsx ──────────

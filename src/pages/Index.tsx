...
const STEPS = [
  ...
  { k: "04", title: "Reportes diarios a las · 08:00", desc: "Cada mañana, un informe consolidado de los leads del día agrupados por etiqueta. Automático, sin abrir el panel.", icon: Clock },
];

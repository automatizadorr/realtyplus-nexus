...
export default function Campaigns() {
  ...
  const kpiCards = [
    { label: "CAMPAÑAS IA", value: kpis.total, sub: `${kpis.executing} activas`, icon: Megaphone, color: "text-primary" },
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-foreground">CAMPAÑAS IA</h2>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Historial de CAMPAÑAS IA · clic para ver detalle y ejecutar</CardTitle>
        </CardHeader>
        <CardContent>
